...
<template lang="">
    ...
    <div class="container">
        <div class="row">
            <div class="col col-7">
                <div class="row">
                    <div  v-for="(post, index) in posts" :key="index" class="card card-list m-3" style="width: 14rem;">
                        <div class="card-body">
                            <h5 class="card-title">{{post.name}}</h5>
                            <h6 class="card-subtitle mb-2 text-muted">{{post.state}}</h6>
            ...
            <div class="col col-5">
                ...
                <div v-else>
                    <br />
                    <p>Por Favor Has Click en un Post...</p>
                </div>
            </div>
        </div>
    </div>
